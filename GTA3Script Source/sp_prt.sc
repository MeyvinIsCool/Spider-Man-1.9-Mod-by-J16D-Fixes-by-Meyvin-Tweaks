...
SWITCH idVar
    ...
    CASE 6  //ID:6  ||STREET CRIMES MISSION PASSED
        ...
        ENDWHILE
        BREAK
    CASE 7  //ID:7  ||PIZZA TIME MISSION PASSED
        // IN: {id} {total xp} {mission xp} {extra time xp}
        GOSUB play_sfx_mission_end
        GOSUB load_textures_street_crimes
        timera = 0
        WHILE TRUE
            GOSUB draw_pizza_time_mission_succesful
            GOSUB draw_street_crimes_key_press_succesful
            IF timera > 2000
                IF IS_BUTTON_PRESSED PAD1 SQUARE           // ~k~~PED_JUMPING~
                    WHILE IS_BUTTON_PRESSED PAD1 SQUARE           // ~k~~PED_JUMPING~
...
drawPowerIcon:
    ...
    SWITCH idPowers
        ...
        CASE equalizer
            USE_TEXT_COMMANDS FALSE
            SET_SPRITES_DRAW_BEFORE_FADE TRUE
            DRAW_SPRITE idIconEQ (320.0 55.0) (sx sy) (255 255 255 255)
            BREAK     
        CASE quad_damage
            USE_TEXT_COMMANDS FALSE
            SET_SPRITES_DRAW_BEFORE_FADE TRUE
...
//-+----------------------------------- PIZZA TIME 
draw_pizza_time_mission_succesful:
    //iTempVar2     // Total XP
    //iTempVar3     // Mission completed XP
    ...
    CLEO_CALL GUI_DrawBoxOutline_WithText 0 (60.0 145.0) (50.0 15.0) (255 255 255 0) (1.0) (0 0 0 0) (255 255 253 230) 812 19 0.0 0.0  // Delivery
    CLEO_CALL GUI_DrawBox_WithNumber 0 (120.0 146.0) (50.0 15.0) (255 255 255 0) 122 19 0.0 0.0 iTempVar3  //+~1~

    CLEO_CALL GUI_DrawBoxOutline_WithText 0 (60.0 165.0) (50.0 15.0) (255 255 255 0) (1.0) (0 0 0 0) (255 255 253 230) 814 19 0.0 0.0  // Extra Time
    CLEO_CALL GUI_DrawBox_WithNumber 0 (120.0 166.0) (50.0 15.0) (255 255 255 0) 122 19 0.0 0.0 iTempVar4    //+~1~
