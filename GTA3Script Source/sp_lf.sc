...
LVAR_INT i p pl_health pl_max_health iFocusCounter iHits
            ...
            IF NOT IS_CHAR_DEAD player_actor
                ...
                IF toggleSpiderMod = 1 //TRUE
                    ...
                    IF isInMainMenu = 0     //1:true 0: false  
                        ...
                        GET_CLEO_SHARED_VAR varFocusCount iHits  

                        IF pl_max_health > pl_health
                        AND iFocusCounter >= 15

                            GET_CLEO_SHARED_VAR varUseFocus iFocusCounter  // Focus Bar Value Updater
                            IF iFocusCounter >= 15
                            ...
                            GET_CLEO_SHARED_VAR varFocusCount iHits     // Fix Focus Hits Not Getting Reset
                            IF iHits >= 15
                            AND iHits <= 29
                                iHits -= 15
                            ...
                            //PRINT_FORMATTED_NOW "FocusValue %i Can be use" 1 iFocusCounter
                            GOSUB getHealthMath
                            //GET_CHAR_HEALTH player_actor iCurrentHealth
                            timera = 0
                            WHILE 700 > timera
                                WAIT 5
                                iCurrentHealth += 1
