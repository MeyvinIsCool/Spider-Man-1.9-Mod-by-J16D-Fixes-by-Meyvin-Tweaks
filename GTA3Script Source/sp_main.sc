...
ENDIF
    ...
    ENDIF
    //Screwball Mission Trigger     //additional  
    IF DOES_FILE_EXIST "CLEO\SpiderJ16D\sp_scrb.cs"
        ...
        CASE 1
            SWITCH randomVal
                ...
                CASE 5
                    ...
                    BREAK   
                CASE 6
                    TASK_PLAY_ANIM_NON_INTERRUPTABLE player_actor ("swing_L_G" "spider") 26.0 (0 1 1 1) -2
                    SET_CHAR_ANIM_CURRENT_TIME player_actor ("swing_L_G") fProgress
                    SET_CHAR_ANIM_PLAYING_FLAG player_actor ("swing_L_G") STOP
                    BREAK                                                          
            ENDSWITCH
            BREAK
        CASE 2
            SWITCH randomVal
                ...
                CASE 5
                    ...
                    BREAK  
                CASE 6
                    TASK_PLAY_ANIM_NON_INTERRUPTABLE player_actor ("swing_R_G" "spider") 26.0 (0 1 1 1) -2
                    SET_CHAR_ANIM_CURRENT_TIME player_actor ("swing_R_G") fProgress
                    SET_CHAR_ANIM_PLAYING_FLAG player_actor ("swing_R_G") STOP
                    BREAK                                        
            ENDSWITCH
            BREAK
        DEFAULT
        ...
        CASE 1
            SWITCH randomVal
                ...
                CASE 5
                    ...
                    BREAK
                CASE 6
                    TASK_PLAY_ANIM_NON_INTERRUPTABLE player_actor ("swing_E_C" "spider") 50.0 (0 1 1 0) -2
                    WAIT 0
                    SET_CHAR_ANIM_SPEED player_actor "swing_E_C" 1.4
                    BREAK
            ENDSWITCH
            BREAK
        CASE 2
            SWITCH randomVal
                ...
                CASE 5
                    ...
                    BREAK
                CASE 6 
                    TASK_PLAY_ANIM_NON_INTERRUPTABLE player_actor ("swing_E_C_R" "spider") 50.0 (0 1 1 0) -2
                    WAIT 0
                    SET_CHAR_ANIM_SPEED player_actor "swing_E_C_R" 1.4
                    BREAK
            ENDSWITCH
