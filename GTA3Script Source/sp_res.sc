...
WAIT 0
STREAM_CUSTOM_SCRIPT_FROM_LABEL sp_ttf_InternalThread rwCrosshair
WAIT 0
STREAM_CUSTOM_SCRIPT_FROM_LABEL sp_ttg_InternalThread rwCrosshair
WAIT 0
STREAM_CUSTOM_SCRIPT_FROM_LABEL sp_tth_InternalThread rwCrosshair
WAIT 0
STREAM_CUSTOM_SCRIPT_FROM_LABEL sp_tti_InternalThread rwCrosshair
WAIT 0
...
{
// iPhotoBombCamID = 5
sp_ttf_InternalThread:      //Reservoir 6
LVAR_INT rwCrosshair    //in
LVAR_INT player_actor baseObject iWebActor iWebActorR sfx
LVAR_INT flag_photo_mode onmission toggleSpiderMod isInMainMenu
LVAR_FLOAT x[2] y[2] z[2]
...
{
// iPhotoBombCamID = 6
sp_ttg_InternalThread:      //Reservoir 7
LVAR_INT rwCrosshair    //in
LVAR_INT player_actor baseObject iWebActor iWebActorR sfx
LVAR_INT flag_photo_mode onmission toggleSpiderMod isInMainMenu
LVAR_FLOAT x[2] y[2] z[2]
...
{
// iPhotoBombCamID = 7
sp_tth_InternalThread:      //Reservoir 8
LVAR_INT rwCrosshair    //in
LVAR_INT player_actor baseObject iWebActor iWebActorR sfx
LVAR_INT flag_photo_mode onmission toggleSpiderMod isInMainMenu
LVAR_FLOAT x[2] y[2] z[2]
                    ...
                    IF IS_CHAR_REALLY_IN_AIR player_actor
                        IF LOCATE_CHAR_DISTANCE_TO_COORDINATES player_actor x[0] y[0] z[0] 10.0
                            ...
                            AND NOT IS_BUTTON_PRESSED PAD1 CIRCLE           // ~k~~PED_FIREWEAPON~   
                                zAngle = 180.0
                                SET_CHAR_HEADING player_actor zAngle
                                GOSUB destroyTwoWebs_r8
                                GOSUB createTwoWebs_r8
                                    zAngle = 180.0
                                    GOSUB animSequence_r8
                                GOSUB destroyTwoWebs_r8
                                WAIT 500     
                            ENDIF
                        ELSE
        ...
        WHILE IS_CHAR_PLAYING_ANIM player_actor ("t_tower_A")
            ...
            ELSE
                IF IS_OBJECT_ATTACHED baseObject
                    ...
                    DETACH_OBJECT baseObject (0.0 0.0 0.0) FALSE
                    SET_OBJECT_COORDINATES baseObject (x[0] y[0] z[0])
                    GOSUB playSFXSound_r8
                ENDIF
                GOSUB add_force_to_char_r8
                IF  currentTime > 0.778     //frame 70/90
                    BREAK
                ENDIF
            ENDIF
...
{
// iPhotoBombCamID = 8
sp_tti_InternalThread:      //Reservoir 9
LVAR_INT rwCrosshair    //in
LVAR_INT player_actor baseObject iWebActor iWebActorR sfx
LVAR_INT flag_photo_mode onmission toggleSpiderMod isInMainMenu
LVAR_FLOAT x[2] y[2] z[2]
                    ...
                    IF IS_CHAR_REALLY_IN_AIR player_actor
                        IF LOCATE_CHAR_DISTANCE_TO_COORDINATES player_actor x[0] y[0] z[0] 10.0
                            ...
                            AND NOT IS_BUTTON_PRESSED PAD1 CIRCLE           // ~k~~PED_FIREWEAPON~   
                                zAngle = 180.0
                                SET_CHAR_HEADING player_actor zAngle
                                GOSUB destroyTwoWebs_r9
                                GOSUB createTwoWebs_r9
                                    zAngle = 180.0
                                    GOSUB animSequence_r9
                                GOSUB destroyTwoWebs_r9
                                WAIT 500     
                            ENDIF
                        ELSE
        ...
        WHILE IS_CHAR_PLAYING_ANIM player_actor ("t_tower_A")
            ...
            ELSE
                IF IS_OBJECT_ATTACHED baseObject
                    ...
                    DETACH_OBJECT baseObject (0.0 0.0 0.0) FALSE
                    SET_OBJECT_COORDINATES baseObject (x[0] y[0] z[0])
                    GOSUB playSFXSound_r9
                ENDIF
                GOSUB add_force_to_char_r9
                IF  currentTime > 0.778     //frame 70/90
                    BREAK
                ENDIF
            ENDIF
